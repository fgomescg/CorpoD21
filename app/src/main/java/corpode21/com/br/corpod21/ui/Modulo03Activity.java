...
public class Modulo03Activity extends BaseSingleActivity {
    ...
    protected void preencheCards()
    {
        ...
        cards.add(montaCards("2° dia",getString(R.string.ex_abdomen), getString(R.string.url_super_queima), getString(R.string.video_alongamento_c21)));
        ...
        cards.add(montaCards("4° dia",getString(R.string.ex_pernas_gluteos),getString(R.string.url_super_queima), getString(R.string.video_alongamento_c21)));
