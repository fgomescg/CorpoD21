...
public class Modulo06Activity extends BaseSingleActivity {
    ...
    protected void preencheCards()
    {
        ...
        cards.add(montaCards("1° dia",getString(R.string.top_treino), getString(R.string.url_top_treino) ));
        cards.add(montaCards("2° dia",getString(R.string.rapido_e_furioso), getString(R.string.url_rapido_furioso) ));
        cards.add(montaCards("3° dia",getString(R.string.super_queima), getString(R.string.url_super_queima) ));
        cards.add(montaCards("4° dia",getString(R.string.top_treino), getString(R.string.url_top_treino )));
